...
import { Home, ClipboardList, Package, Users, LogOut, FlaskConical, Truck, UserCircle, BarChart2 } from 'lucide-react';
...
export default function AdminPanel({ onNavigate, onLogout, currentView, user }) {
  ...
  const navItems = [
    ...
    { name: 'Reporte por Producto', view: 'productReport', icon: <BarChart2 size={20} />, roles: ['Super Admin', 'Admin', 'Coordinador de vendedores', 'Gerente de laboratorio'] },
