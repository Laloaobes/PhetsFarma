...
// CAMBIO: Función para formatear un número con separador de miles y 2 decimales.
const formatNumber = (num) => {
  if (isNaN(num)) return "0.00";
  // Usamos 'es-MX' para el formato mexicano con separador de miles.
...
const ProductRow = ({ item, index, onUpdate, onRemove, productList, laboratory, user, maxDiscountPercentage }) => {
  ...
  const handleProductSelect = (productName) => {
    ...
    if (product) {
      ...
      // CAMBIO: Usamos toFixed para el cálculo, no para la visualización
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-2 items-center">
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="flex items-center">
            ...
            {/* CAMBIO: Aplicamos el formato al valor del precio */}
        ...
        <div className="col-span-1 md:col-span-2 flex flex-col items-end text-right">
          {itemDiscountAmount > 0 ? (
            // CAMBIO: Aplicamos el formato a los subtotales
            <span className="text-xs text-gray-600">Subt: ${formatNumber(rawItemSubtotal)}</span>
          ) : (
            <span className="text-xs text-gray-600">&nbsp;</span>
          )}
          {/* CAMBIO: Aplicamos el formato al total final del ítem */}
...
export default function OrderForm({ 
  ...
  const handleSubmit = () => {
    // La línea que he modificado para permitir productos de 0.00
          ...
          <div className="text-right w-full max-w-xs">
            {itemLevelDiscountAmount > 0 ? (
              <div className="flex justify-between py-1">
                ...
                {/* CAMBIO: Aplicamos el formato al subtotal */}
              ...
              <div className="flex justify-between py-1">
                ...
                {/* CAMBIO: Aplicamos el formato al subtotal cuando no hay descuento */}
                <span className="font-medium text-gray-800">${formatNumber(rawSubtotal)}</span>
              </div>
            )}
            {itemLevelDiscountAmount > 0 && (
              <div className="flex justify-between py-1 border-t">
                ...
                {/* CAMBIO: Aplicamos el formato al monto del descuento */}
            ...
            <div className="flex justify-between py-2 border-t mt-2">
              ...
              {/* CAMBIO: Aplicamos el formato al total final */}
