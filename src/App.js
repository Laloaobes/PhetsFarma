...
export default function App() {
  ...
  const renderView = () => {
    ...
    switch (currentView) {
      ...
      case 'reports':
        return <ReportsView onNavigate={handleNavigate} distributors={distributors} laboratories={initialData.laboratories} user={user} onDeleteOrder={genericHandlers('orders').handleDeleteItem} representatives={representatives} />;
      
      // MODIFICADO: Se añaden las props que faltaban para los filtros
      case 'productReport':
        return (
          <ProductReportView 
            products={products} 
